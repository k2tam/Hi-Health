...
class FakeProfileViewModel {
    ...
    func fetchFakeProfileTable(completion: @escaping (_ profileTableData: ProfileTable) -> Void ) {
        ...
        let groupedActivites = [
            SpecificActivity(typeActivity: "Walk", activities: [Activity(distance: 1852.9, movingTime: 365, startDate: "2023-07-15T13:04:39Z", activityType: "Walk"),Activity(distance: 189.4, movingTime: 117, startDate: "2023-07-17T03:56:32Z", activityType: "Walk")]),
             
             SpecificActivity(typeActivity: "EBikeRide", activities: [Activity(distance: 5805.4, movingTime: 746, startDate: "2023-07-14T11:10:07Z", activityType: "EBikeRide")]
                                             )]
